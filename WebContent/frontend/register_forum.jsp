	...
	<div id="registerForm">
		...
		<div class="container-fluid">
			...
			<div
				...
				<h2 class="sub-header">Kullanıcı Kayıt</h2>


				<form action="register_customer" id="registerCustomerForum"
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-sm-3 control-label">Şifre Doğrulama</label>
								<div class="col-sm-8">
									<input type="password" class="form-control"
					...
					<c:if test="${message != null}">
					    <c:if test="${success != null}">
							<div class="alert alert-success" role="alert">
								<c:out value="${message}" />
								<a href='login' class='text-white'> Giriş Yapmak için Tıklayınız.. </a>
							</div>
						</c:if>
							...
							$('#registerCustomerForum')
									...
									.bootstrapValidator(
									        ...
									        .on('keyup', '[name="password"]', function() {
									            ...
									            $('registerCustomerForum')
									                    .bootstrapValidator('enableFieldValidators', 'customer_password', !isEmpty)
									                    .bootstrapValidator('enableFieldValidators', 'customer_confirm_password', !isEmpty);
								
									            // Revalidate the field when user start typing in the password field
									            if ($(this).val().length == 1) {
									                $('registerCustomerForum').bootstrapValidator('validateField', 'customer_password')
									                                .bootstrapValidator('validateField', 'customer_confirm_password');
									            }
									        });
