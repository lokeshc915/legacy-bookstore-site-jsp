		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row placeholders">
				<div class="create-new-user">
					<a href="book_forum"><span class="fa fa-book icon-category"></span>
					...
					<tbody>
						<c:forEach var="book" items="${bookList}">
							...
							<tr>
								...
								<td><fmt:formatDate value="${book.lastUpdatedDate}" pattern="dd/MM/yyyy HH:mm:ss"/></td>  
								<td>
									<form action="edit_delete_book" action="GET" class="form-inline">
