		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row placeholders">
				<div class="create-new-user">
					<span class="fa fa-truck icon-review"></span>
						<h4>Review</h4>
				</div>
			</div>
			...
			<h2 class="sub-header">List All Orders</h2>
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<% int i=1; %>
					<tbody>
						<c:forEach var="bookOrder" items="${bookOrdersList}">
							...
							<tr>
								...
								<td>
									<form action="edit_delete_detail_order" action="GET" class="form-inline">
									
									    <input id="orderId" name="orderId" type=hidden  value="${bookOrder.id}">
									    
									    <button type="submit" name="button" class="btn btn-info" value="Detail">Detail</button>
