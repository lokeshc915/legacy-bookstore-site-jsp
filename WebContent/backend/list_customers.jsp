...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row placeholders">
				<div class="create-new-user">
					<a href="customer_forum"><span class="fa fa-user icon-customer"></span>
						<h4>Customer</h4></a> <span class="text-muted">Create New Customer</span>
				</div>
			</div>
			...
			<h2 class="sub-header">List All Customers</h2>
					...
					<tbody>
						<c:forEach var="customer" items="${customerList}" varStatus="status">
							...
							<tr>
								...
								<td><c:out value="${customer.city.cityName}" /></td>
								<td><c:out value="${customer.district.districtName}" /></td>
								<td><c:out value="${customer.phoneNumber}" /></td>
								<td><c:out value="${customer.zipCode}" /></td>
								<td><c:out value="${customer.password}" /></td>
								<td><fmt:formatDate value="${customer.registerDate}" pattern="dd/MM/yyyy HH:mm:ss" /></td>
								<td>
									<form action="edit_delete_customer" action="GET" class="form-inline">
