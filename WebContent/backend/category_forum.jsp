	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<c:if test = "${category != null}">
				<h2 class="sub-header">Update Category</h2>
			</c:if>
			
			<c:if test = "${category == null}">
				<h2 class="sub-header">Creating Category</h2>
			</c:if>
			
			
			<c:if test = "${category != null}">
				<form action="update_category" id="createCategoryForum" method="POST" class="form-horizontal">
				<input id="categoryId" name="categoryId" type=hidden  value="${category.id}">
			</c:if>
			
			<c:if test = "${category == null}">
				<form action="create_category" id="createCategoryForum" method="POST" class="form-horizontal">
			</c:if>
