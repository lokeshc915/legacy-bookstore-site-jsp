		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row placeholders">
				<div class="create-new-user">
					<a href="article_forum.jsp"><span
						class="fa fa-bars icon-article"></span>
						<h4>Article</h4></a> <span class="text-muted">Create New
						Article</span>
				</div>
			</div>
			...
			<h2 class="sub-header">List All Articles</h2>
					...
					<tbody>
						<c:forEach var="article" items="${articleList}">
							...
							<tr>
								...
								<td>
									<form action="edit_delete_article" action="GET"
										class="form-inline">
